...
function showWelcome() {
    ...
    try {
        document.getElementById("welcome-info").innerHTML = `欢迎来自 <b><span style="color: var(--efu-color);font-size: var(--efu-gl-size)">${s}</span></b> 的朋友🍂<br>${e}🍂<br>当前位置距博主约 <b><span style="color: var(--efu-ip-color)">${t}</span></b> 公里！<br>您的IP地址为：<b><span style="font-size: 15px;">${o}</span></b><br>${a} <br>`
    } catch (e) {
