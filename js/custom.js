...
function showWelcome() {
    ...
    try {
        document.getElementById("welcome-info").innerHTML = `欢迎来自 <b><span style="color: var(--efu-color);font-size: var(--efu-gl-size)">${s}</span></b> 的好厚米🍂<br>你是不是还在努力的<b>工作or学习</b>？<br>放下手上的工作<b>休息一下</b>吧~<br>您的IP地址为：<b><span style="font-size: 15px;">${o}</span></b><br>${a} <br>`
    } catch (e) {
